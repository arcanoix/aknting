...
@section('title', trans('general.title.edit', ['type' => trans_choice('payroll::general.pay_calendars', 1)]))

@section('content')
    {!! Form::model($pay_calendar, [
        'id' => 'pay-calendar',
        'method' => 'PATCH',
        'route' => ['payroll.pay-calendars.update', $pay_calendar->id],
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    {{ Form::selectGroup('type', trans_choice('general.types', 1), 'bars', $types, $pay_calendar->type, ['required' => 'required', 'change' => 'onChangeType', 'sort-options' => 'false']) }}
                    ...
                    <div class="form-group col-md-6 required d-none" :class="[{'has-error': {{ 'form.errors.get("pay_day")' }} }, {'show': field.pay_day}]">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            {!! Form::text('pay_day', $pay_calendar->pay_day, [
                                'class' => 'form-control',
        ...
        @can('update-payroll-pay-calendars')
            <div class="card">
