<div class="card-header border-bottom-1 show-transaction-card-header">
    <b class="text-sm font-weight-600">{{ trans('general.name') }}</b> <a class="float-right text-xs">{{ $deduction->pay_item->pay_item  }}</a>
</div>
<div class="card-header border-bottom-1 show-transaction-card-header">
...
<div class="card-header border-bottom-1 show-transaction-card-header">
    <b class="text-sm font-weight-600">{{ trans('recurring.recurring') }}</b> <a class="float-right text-xs">{{ trans('payroll::deductions.deduction_recurring.' . $deduction->recurring) }}</a>
</div>
<div class="card-header border-bottom-1 show-transaction-card-header">
