...
class DebitNotesInTotalProfit extends Widget
{
    /**
    ...
    public function compose(View $view)
    {
        ...
        $totals['grand'] = $totals['grand']->add(money($debits_current + $debits_open + $debits_overdue, setting('default.currency'), true));
        $totals['open'] = $totals['open']->add(money($debits_open , setting('default.currency'), true));
        $totals['overdue'] = $totals['overdue']->add(money($debits_overdue, setting('default.currency'), true));
